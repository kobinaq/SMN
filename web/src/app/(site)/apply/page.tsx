  ...
  return (
    <>
      <PageHero
        ...
        description={`Next intake ${site.cohort.startDate}. Applications are reviewed within 3-5 business days. Live sessions run on Google Classroom. Community lives on Discord.`}
      />
