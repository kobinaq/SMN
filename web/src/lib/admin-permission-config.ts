...
const domains: Record<string, Domain> = {
  ...
  "cohort-applications": { read: ["content", "support", "analyst", "learning"], write: ["content", "support", "learning"] },
  ...
  "lms-sessions": { read: ["learning", "support", "analyst"], write: ["learning"] },
  "lms-attendance": { read: ["learning", "support", "analyst"], write: ["learning", "support"] },
  "lms-announcements": { read: ["learning", "support", "analyst"], write: ["learning"] },
  "lms-discussion-posts": { read: ["learning", "support", "analyst"], write: ["learning", "support"] },
  "lms-assessments": { read: ["learning", "analyst"], write: ["learning"] },
  "lms-submissions": { read: ["learning", "support", "analyst"], write: ["learning", "support"] },
  ...
  events: { read: ["content", "support", "analyst"], write: ["content", "support"] },
  "event-registrations": { read: ["content", "support", "analyst"], write: ["content", "support"] },
  payments: { read: ["content", "learning", "support", "analyst"], write: ["support"] },
