...
export const ecosystem = [
  ...
  {
    title: "Connect",
    body: "Discord, mentors, and peers you can keep learning with after a program ends.",
  },
  {
    title: "Grow",
...
export const events = [
  {
    ...
    date: "2026-08-14",
    time: "6:00 PM WAT",
    summary: "A free session on using AI day to day without handing over the thinking.",
  ...
  },
  {
    ...
    date: "2026-08-28",
    time: "5:30 PM WAT",
    summary: "Share work, get feedback, and meet peers and mentors in a small group setting.",
  ...
  },
  {
    ...
    date: "2026-09-05",
    time: "10:00 AM WAT",
    summary: "Brief a campaign, design the plan, present, and get critique.",
...
export const cohortFaqs = [
  ...
  },
  {
    ...
    a: "Live sessions run on Google Classroom. You’ll also join the SMN Discord for community, feedback, and support.",
  },
  {
