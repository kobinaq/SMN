...
export function StaffResetPasswordForm() {
  ...
  if (!token) {
    return (
      <p className="text-sm text-text-2">
        ...
        <Link href="/staff/forgot-password" className="text-accent hover:text-text-1">
          Request a new link
        </Link>
        .
      </p>
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3 sm:space-y-4">
      <label className="block text-sm text-text-2" htmlFor="staff-reset-password">
        New password
        <input
      ...
      <label className="block text-sm text-text-2" htmlFor="staff-reset-confirm">
        Confirm password
        <input
      ...
      <p className="pt-2 text-center text-sm text-text-3">
        <Link href="/staff/login" className="text-accent hover:text-text-1">
          Back to sign in
        </Link>
      </p>
    </form>
